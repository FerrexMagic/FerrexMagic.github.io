...
function cambiarTemaIncio(checked) {
  ...
  redes.forEach((red) => {
    red.style.backgroundColor = checked ? "rgb(170, 169, 169)" : "rgb(56, 50, 50)";
  });
...
function cargarBoton() {
  const boton = `
    ...
    `;
  document.getElementById("divBoton").innerHTML = boton;
...
function cargarRedes() {
  const redes = `
    <div class="card">
      <a class="socialContainer containerOne" href="#" name="botonRedes">
      ...
      <a class="socialContainer containerTwo" href="#" name="botonRedes">
      ...
      <a class="socialContainer containerThree" href="#" name="botonRedes">
      ...
      <a class="socialContainer containerFour" href="#" name="botonRedes">
