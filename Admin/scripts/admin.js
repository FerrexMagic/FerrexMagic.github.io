...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document
      ...
      .addEventListener("click", function (event) {
        if (event.target.tagName === "A" || event.target.closest("a")) {
          ...
          switch (targetLink.textContent.trim()) {
  ...
  function loadGraficaMes() {
    const panel = getPanel();
    document.getElementById("contenido").innerHTML = panel;
    graficasConfig[1]();
  }

  function loadGraficaTrim() {
    const panel = getPanel();
    document.getElementById("contenido").innerHTML = panel;
    graficasConfig[2]();
  }

  function loadGraficaAnyo() {
    const panel = getPanel();
    document.getElementById("contenido").innerHTML = panel;
    graficasConfig[3]();
  }
  ...
  function loadSvg() {
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    document.querySelector("body").insertAdjacentHTML("beforebegin", svg);
  }
